...
namespace Ok99\PrivateZoneCore\AdminBundle\Controller;
...
class AuditController extends BaseAuditController
{
     ...
     *
     * @Route("/admin/history/{id}/revision/{revision}/{adminCode}", name="ok99_privatezone_admin_history_back_to_revision")
     */
    ...
    public function render($view, array $parameters = array(), Response $response = null)
    {
        ...
        $parameters['previous_user'] = $this->getPreviousUser();

        return parent::render($view, $parameters, $response);
    }

    protected function getPreviousUser()
    {
